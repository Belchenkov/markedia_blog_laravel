...
<div class="wrapper">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <img
                                src="<?php echo e(asset('assets/admin/img/user1-128x128.jpg')); ?>"
                                alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <img
                                src="<?php echo e(asset('assets/admin/img/user8-128x128.jpg')); ?>"
                                alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="media">
                            <img
                                src="<?php echo e(asset('assets/admin/img/user3-128x128.jpg')); ?>"
                                alt="User Avatar"
                                class="img-size-50 img-circle mr-3"
                            >
                            <div class="media-body">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="<?php echo e(url('/')); ?>" target="_blank" class="brand-link">
            <img
                src="<?php echo e(asset('assets/admin/img/AdminLTELogo.png')); ?>"
                alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img
                        src="<?php echo e(asset('assets/admin/img/user2-160x160.jpg')); ?>"
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2021 <a href="http://adminlte.io">Markedia</a>.</strong> All rights
        reserved.
    </footer>
...
<script src="<?php echo e(asset('assets/admin/ckeditor5/build/ckeditor.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/ckfinder/ckfinder.js')); ?>"></script>
