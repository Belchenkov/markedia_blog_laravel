        ...
        <div class="blog-title-area">
            <ol class="breadcrumb hidden-xs-down">
                ...
                <li class="breadcrumb-item"><a
                        href="<?php echo e(route('categories.single', ['slug' => $post->category->slug])); ?>"
                    ><?php echo e($post->category->title); ?></a>
                </li>
                <li class="breadcrumb-item active"><?php echo e($post->title); ?></li>
            </ol>

            <span class="color-yellow">
                <a href="<?php echo e(route('categories.single', ['slug' => $post->category->slug])); ?>"
                                          title=""><?php echo e($post->category->title); ?></a></span>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/posts/show.blade.php ENDPATH**/ ?>